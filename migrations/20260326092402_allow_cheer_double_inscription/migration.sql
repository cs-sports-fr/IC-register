/*
  ...
  - A unique constraint covering the columns `[teamId,email]` on the table `Participant` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Participant_teamId_email_key" ON "Participant"("teamId", "email");
