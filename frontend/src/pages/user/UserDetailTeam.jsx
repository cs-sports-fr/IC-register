...
{team?.sportId === 19 && (
    <Alert severity="error">
        En golf, chaque participant doit déposer <span style={{ fontWeight: "bold" }}>deux pièces distinctes</span> dans l&apos;onglet de modification du joueur : le certificat médical ou l&apos;attestation de santé <span style={{ fontWeight: "bold" }}>et</span> la licence PDF, avec le numéro de licence.
    </Alert>
)}
...
const getColumns = (isGolf) => [
    ...
    { label: "Certificat | Attestation Ajouté", align: "center", name: "certif", type: "boolean" },
    ...
    ...(isGolf ? [
        ...
        { label: "Licence PDF ajoutée", align: "center", name: "licencePdf", type: "boolean" },
